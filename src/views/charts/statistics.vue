...
<template>
  ...
  <div class="stbox">
    ...
    <div>
      ...
      <el-row :gutter="23">
        <el-col :span="isFulfilled" class="text-c">
          <div class="paybox">
            <div class="cavasbox" ref="meiguiEchart"></div>
          </div>
        </el-col> 
      </el-row>
    </div>
...
export default {
  ...
  methods: {
    ...
    getmeigui(){
      this.chart = Chart.init(this.$refs.meiguiEchart)
      this.chart.setOption(this.meiguioption)
    }
  }
};
</script>
